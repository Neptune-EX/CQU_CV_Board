...
% 填写个人信息
% 学院
\newcommand{\school}{弘深学院 | Hongshen Honors School} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@stu.cqu.edu.cn}{youremail@stu.cqu.edu.cn}
        \hspace{4em}
        % 手机号
...
% 如果有多页简历，请把页眉页脚和背景复制粘贴到第二页的内容之前
    ...
    \section{\makebox[\widthof{\faChalkboardTeacher}][c]{\color{CQU_Blue}{\faChalkboardTeacher}}\quad 项目与教学}
    \vspace{0.5em}
    ...
    % % 竞赛经历
    % \section{\makebox[\widthof{\faTrophy}][c]{\color{CQU_Blue}{\faTrophy}}\quad 竞赛经历}
    % \vspace{-1em}
    % \begin{table}[h!]
